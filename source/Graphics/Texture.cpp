...
{
Texture::Texture(GfxDevice_DX11& render, Image const& image)
{
  HRESULT hr;
...
RenderTexture::RenderTexture(GfxDevice_DX11& render, int width, int height)
{
  HRESULT hr;
...
void RenderTexture::Clear(GfxDevice_DX11& render, DirectX::XMFLOAT4 color)
{
