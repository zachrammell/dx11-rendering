...
Cubemap::Cubemap(GfxDevice_DX11& render, std::string const& folder)
...
Cubemap::Cubemap(GfxDevice_DX11& render, RenderTexture render_textures[6])
  : cube_texture(nullptr),
  cube_resource_view(nullptr)
{
...
void Cubemap::UpdateFromRenderTextures(GfxDevice_DX11& render, RenderTexture render_textures[6])
{
...
void Cubemap::Use(GfxDevice_DX11& render, int slot)
{
